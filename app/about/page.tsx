              ...
              <div className="border-l-4 border-blue-600 pl-4">
                ...
                <div className="space-y-3">
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <p className="text-gray-700 text-xs">
                      Full-stack development with Next.js, Supabase integration,
                      core application logic, and shadcn/ui component system
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <h4 className="text-base font-semibold text-blue-600 mb-1">
                    ...
                    <p className="text-gray-700 text-xs">
                      Interactive mapping with react-leaflet, GPS proximity
                      detection logic, and AR image implementation
                    </p>
                  </div>
                </div>
              </div>
